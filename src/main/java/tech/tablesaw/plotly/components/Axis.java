...
import tech.tablesaw.plotly.traces.BarTrace.BarBuilder;
...
public class Axis extends Component {
    ...
    protected Map<String, Object> getJSONContext() {
        ...
        if (!autoRange.equals(DEFAULT_AUTO_RANGE)) {
        ...
        if (scaleRatio != DEFAULT_SCALE_RATIO) {
            context.put("scaleRatio", scaleRatio);
        }
        if (!constrain.equals(DEFAULT_CONSTRAIN_RANGE)) {
    ...
    public static class AxisBuilder {
        ...
        public AxisBuilder rangeslider(RangeSlider slider) {
            this.rangeSlider = slider;
            return this;
        }

        public AxisBuilder matches(String matches) {
    ...
    public static class RangeSlider {
        private final Boolean autorage;
        private final Boolean visible;

        RangeSlider(Builder builder) {
            autorage = builder.autorange;
            visible = builder.visible;
        }
        ...
        public static class Builder {
            ...
            public Builder autorange(Boolean val) {
                autorange = val;
                return this;
            }
